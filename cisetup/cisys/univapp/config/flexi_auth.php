<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	*/ 
	...
	/**
	 * Auth uses CI sessions to store and serve authentication data between pages loads.
	 * All Auth session data is stored together within one session array, this helps maintain a tidy session structure.
	*/ 
	...
	*/
	...
	/**
	 * Auth uses cookies to store and serve authentication data for the next time a user visits the website.  
	 * 
	...
	*/
	$config['security']['static_salt'] = 'CN0cnrkYyUfZTvNeKjaq7IRCplJwCDkx';
	...
	*/
	$config['security']['recaptcha_public_key']	= '6Ld8gdwSAAAAAAt0r2izgCsMeYInvlQajYzLDi4j';
	$config['security']['recaptcha_private_key'] = '6Ld8gdwSAAAAACcG9KneGF6JEi_Mm8mbouLqfs3-'; 
